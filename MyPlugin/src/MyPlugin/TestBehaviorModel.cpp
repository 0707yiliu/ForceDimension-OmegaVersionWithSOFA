...
TestBehaviorModel::TestBehaviorModel()
...
void TestBehaviorModel::init()
{
}

void TestBehaviorModel::reinit()
{
}

void TestBehaviorModel::updatePosition(double dt)
{
    SOFA_UNUSED(dt);
}

int TestBehaviorModelClass = core::RegisterObject("Dummy component with a custom widget.").add< TestBehaviorModel >();
