 ...
 */
class SOFA_MYPLUGIN_API TestBehaviorModel : public sofa::core::BehaviorModel
{

public:
    SOFA_CLASS(TestBehaviorModel, sofa::core::BehaviorModel);

protected:
    TestBehaviorModel();
    virtual ~TestBehaviorModel() override;
